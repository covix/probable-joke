...
GLOG_logtostderr=1 ${CAFFE_HOME}/build/tools/extract_image_features.bin c3d_sport1m_feature_extractor_frm_v1.1.prototxt conv3d_deepnetA_sport1m_iter_1900000_v1.1.caffemodel $GPU_ID $BATCH_SIZE $BATCH_NUMBERS ucf101_video_frame.prefix pool5 res5b
