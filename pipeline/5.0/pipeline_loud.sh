...
if [[ ! -d $LOUD_FRAMES_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_frames_train -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_FEATURES_TRAIN ]]; then
    ...
    echo oarsub -l /core=1 -S $CMD
    OAR_SUB_OUTPUT=`oarsub -n loud_features_train -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_FRAMES_TEST ]]; then
    ...
    echo oarsub -l /core=1 -S $CMD
    OAR_SUB_OUTPUT=`oarsub -n loud_frames_test -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_FEATURES_TEST ]]; then
    ...
    echo oarsub -l /core=1 -S $CMD
    OAR_SUB_OUTPUT=`oarsub -n loud_features_test -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_PCA_FEATURES_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_pca_features_train $ANTERIOR_LOUD_FEATURES_TRAIN -l /core=10 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_PCA_FEATURES_TEST ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_pca_features_test $ANTERIOR_LOUD_FEATURES_TEST $ANTERIOR_LOUD_PCA_FEATURES_TRAIN -l /core=10 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_FRAMES_CLASS_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_frames_class_train $ANTERIOR_LOUD_FRAMES_TRAIN -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_FRAMES_CLASS_TEST ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_frames_class_test $ANTERIOR_LOUD_FRAMES_TEST -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_PCA_FEATURES_CLASS_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_pca_features_class_train $ANTERIOR_LOUD_PCA_FEATURES_TRAIN -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_PCA_FEATURES_CLASS_TEST ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_pca_features_class_test $ANTERIOR_LOUD_PCA_FEATURES_TEST -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_ALIGNMENT_INDEXES_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_alignment_indexes_train $ANTERIOR_LOUD_PCA_FEATURES_CLASS_TRAIN -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_ALIGNMENT_INDEXES_TEST ]]; then
    ...
    CMD="$ALIGNMENT_SCRIPTS_FOLDER/run_align_deep_pca_gctw_test_correct_class.sh $LOUD_PCA_FEATURES_CLASS_TRAIN $LOUD_PCA_FEATURES_CLASS_TEST $LOUD_ALIGNMENT_INDEXES_TEST $ANTERIOR_LOUD_PCA_FEATURES_CLASS_TRAIN $ANTERIOR_LOUD_PCA_FEATURES_CLASS_TEST"
    echo "$CMD"
    OAR_SUB_OUTPUT=$($CMD) 
    ...
    echo
    echo "WAITING IDS"
    echo $ANTERIOR_LOUD_ALIGNMENT_INDEXES_TEST
    echo
...
if [[ ! -d $LOUD_ALIGNED_FRAMES_TRAIN ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_aligned_frames_train $ANTERIOR_LOUD_ALIGNMENT_INDEXES_TRAIN $ANTERIOR_LOUD_FRAMES_CLASS_TRAIN -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
...
if [[ ! -d $LOUD_ALIGNED_FRAMES_TEST ]]; then
    ...
    OAR_SUB_OUTPUT=`oarsub -n loud_aligned_frames_test $ANTERIOR_LOUD_ALIGNMENT_INDEXES_TEST $ANTERIOR_LOUD_FRAMES_TEST -l /core=1 -S "$CMD"`
    echo $OAR_SUB_OUTPUT
