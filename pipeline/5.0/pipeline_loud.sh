...
if [[ ! -d $LOUD_ALIGNED_FRAMES_TRAIN ]]; then
    ...
    python $PYTHON_SCRIPTS_FOLDER/extract_aligned_frames_from_indexes_interface.sh $LOUD_FRAMES_TRAIN $LOUD_ALIGNMENT_INDEXES_TRAIN $LOUD_ALIGNED_FRAMES_TRAIN
...
if [[ ! -d $LOUD_ALIGNED_FRAMES_TEST ]]; then
    ...
    python $PYTHON_SCRIPTS_FOLDER/extract_aligned_frames_from_indexes_interface.sh $LOUD_FRAMES_TEST $LOUD_ALIGNMENT_INDEXES_TEST $LOUD_ALIGNED_FRAMES_TEST
